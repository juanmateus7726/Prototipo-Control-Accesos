...
class Ambiente(models.Model):
    ...
    # 🔹 Nuevo campo: para habilitar/deshabilitar ambientes sin eliminarlos
    ...
    def resumen_protocolos(self):
        ...
        """
        from .models import ProtocoloAmbiente  # Importación diferida para evitar problemas circulares
...
# 🔹 Modelo para las tareas del protocolo
...
# 🔹 Modelo para el checklist de cada ambiente
